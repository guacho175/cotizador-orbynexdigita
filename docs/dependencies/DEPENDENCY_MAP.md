...
| `workbox-build`        | `scripts/generate-service-worker.mjs`, `npm run build` | Generación del Service Worker y precache dentro de `dist/client`, el directorio publicado por Vercel |
