...
import { sortClients, filterClients, paginateClients } from "./clientes-utils.ts";

describe("Clientes Logic", () => {
  test("Orden: Ángela, angelica, Farmacia, víctor, Victor 2, Victor 10", () => {
    const clients = [
    ...
    assert.deepEqual(names, ["Ángela", "angelica", "Farmacia", "víctor", "Victor 2", "Victor 10"]);
  });
