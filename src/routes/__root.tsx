...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cotiza — Cotizaciones profesionales" },
      {
        name: "description",
        content:
          "Crea cotizaciones profesionales en PDF, gestiona clientes y trabaja sin conexión.",
      },
      { name: "theme-color", content: "#0b2545" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "Cotiza" },
